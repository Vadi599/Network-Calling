...
public class EmployeesWithDeleteAdapter extends RecyclerView.Adapter<EmployeesWithDeleteAdapter.EmployeeViewHolder> {
    ...
    private OnDeleteItemClickListener onItemClickListener;
    ...
    public EmployeeViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        ListItemEmployeeWithDeleteBinding binding = ListItemEmployeeWithDeleteBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);
    ...
    public void onBindViewHolder(@NonNull EmployeeViewHolder holder, int position) {
        ...
        holder.btnDelete.setOnClickListener(v -> {
            if (onItemClickListener != null) {
                onItemClickListener.onDeleteItemClicked(employee);
            }
        });
    }
    ...
    public class EmployeeViewHolder extends RecyclerView.ViewHolder {
        ...
        public EmployeeViewHolder(ListItemEmployeeWithDeleteBinding binding) {
            ...
            tvAge = binding.tvAge;
            btnDelete = binding.btnImageDelete;
